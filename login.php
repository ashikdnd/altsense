	...
	<div class="row display-flex">
		<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="landing-content">
				<h1>Welcome to your personal task management system</h1>
				<p>Managing your tasks is now easy
				</p>
			</div>
		</div>
			...
			<div class="registration-login-form">
				...
				<div class="tab-content">
							...
							<div class="row">
								<div class="col col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12">
									<div class="form-group label-floating">
										...
										<input name="full_name" class="form-control" placeholder="" type="text" required>
									</div>
								</div>
								<div class="col col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12">
									<div class="form-group label-floating">
								...
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12"
									<div class="form-group label-floating">
										...
										<input class="form-control" name="password" placeholder="" type="password" requried>
									</div>
					...
					<div class="tab-pane" id="profile" role="tabpanel" data-mh="log-tab">
						...
						<form class="content" method="POST" action="auth.php">
							<div class="row">
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<div class="form-group label-floating">
										<label class="control-label">Username</label>
